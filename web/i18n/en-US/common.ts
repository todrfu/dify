const translation = {
  ...
  actionMsg: {
    ...
    createFailedExceed: 'You have reached the maximum number of workspaces(3 per user).',
  ...
  userProfile: {
    ...
    deleteWorkspaceConfirm: 'Are you sure you want to delete workspace "{{name}}"? This action cannot be undone.',
